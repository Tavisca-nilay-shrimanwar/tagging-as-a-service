...
cluster_name = os.environ.get('TargetClusterName')
retention_period = os.environ.get("ClusterRetention")

write_retention_config(cluster_name, retention_period, ssm_client, s3_client, logger, emailer)