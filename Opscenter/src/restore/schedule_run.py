...
#Setting Variables
cluster_name = os.environ.get("ClusterNameForBackup")
...
keyspaces = 'All'
restore_after_configuring_destination(cluster_name, opscenter_ip, session_id, bucket_name, keyspaces, backup_id, logger, restore_scope="All")
